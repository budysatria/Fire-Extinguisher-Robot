#define light_FR  26    //LED Front Right   pin A0 for Arduino Uno
#define light_FL  28    //LED Front Left    pin A1 for Arduino Uno
#define horn_Buzz 30    //Horn Buzzer       pin A4 for Arduino Uno
#define INB 22 
#define INA 24 
...
void Pemadam(){
    // Putaran Kipas Pemadam Kiri 
  digitalWrite(INA,LOW);
  digitalWrite(INB,HIGH); 
    // Putaran Kipas Pemadam Kanan 
...
switch (command) {
case 'P':Pemadam();break;
case 'p':PemadamOFF();break;
